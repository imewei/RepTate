...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.diffevolpolishcheckBox.setToolTip(QCoreApplication.translate("Dialog", u"If True (default), then the NLSQ-based minimizer is used to polish the best population member at the end, which can improve the minimization slightly. If a constrained problem is being studied then a bounded method is used instead.", None))
#endif // QT_CONFIG(tooltip)
