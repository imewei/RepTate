...
latex_documents = [
    (master_doc, "RepTate.tex", "RepTate Documentation", "Jorge Ramírez", "manual"),
]
...
man_pages = [(master_doc, "reptate", "RepTate Documentation", [author], 1)]
...
bibtex_bibfiles = [
    "manual/Applications/Crystal/bibliography.bib",
    "manual/Applications/Gt/bibliography.bib",
    "manual/Applications/LVE/bibliography.bib",
    "manual/Applications/LVE/refs.bib",
    "manual/Applications/NLVE/bibliography.bib",
    "manual/Applications/React/bibliography.bib",
    "manual/Applications/SANS/bibliography.bib",
    "manual/General/bibliography.bib",
    "papers.bib",
]
